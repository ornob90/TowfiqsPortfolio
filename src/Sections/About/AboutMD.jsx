  ...
  return (
    <Container className="lg:hidden">
      ...
      <div className="min-h-[400px] grid grid-cols-8 grid-rows-10 grid-flow-row-dense mb-12 gap-2">
        {/* image cell */}
        <div className="order-0 row-span-8 image-md">
          <img
        ...
        {/* about cell */}
        <div className="order-1 border border-black  about-md bg-black-dark text-white px-3 pt-3 rounded-lg">
        ...
        {/* project cell */}
        <div className="order-6 border border-black  project-md bg-black-gray text-white rounded-lg p-3 ">
        ...
        {/* skill cell */}
        <div className="order-3 border border-black  skills-md p-3 bg-black-gray text-white rounded-lg flex flex-col justify-between ">
          <div className="flex justify-between mb-6">
        ...
        {/* social cell */}
        <div className="order-4 border border-black  social-md bg-black-dark text-white p-3  flex justify-between flex-col rounded-lg">
        ...
        {/* resume cell */}
        <div className="order-5 border border-black  resume-md font-generalBold flex justify-between flex-col p-2 bg-black-dark rounded-lg text-white">
        ...
        {/* contact cell */}
        <div className="order-6 border border-black  contact-md bg-black-gray text-white p-3 rounded-lg flex flex-col justify-between lg:block">
